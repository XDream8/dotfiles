...
(cua-mode)                           ; use Ctrl-c and Ctrl-v for copy-paste
...
;; Configure built-in paren package
(use-package paren
  :elpaca nil
  :defer 3
  :config
...
;; Configure built-in electric package
...
;; Flycheck is the newer version of flymake.
